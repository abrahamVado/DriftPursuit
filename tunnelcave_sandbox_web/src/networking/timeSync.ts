import { ClockSynchronizer, TimeSyncUpdate } from "../../../typescript-client/src/timeSync";
...
export class TimeSyncController {
  ...
  //2.- Surface the blended offset so rendering systems can align animations to the broker clock.
  currentOffset(): number {
    return this.clock.currentOffset();
  }

  //3.- Provide a helper that projects the authoritative timeline using the synchronised offset.
